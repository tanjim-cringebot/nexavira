    ...
    <footer className="mt-16 sm:mt-20 pb-8 border-t border-green-500 border-opacity-20">
      <div className="pt-8 grid grid-cols-1 md:grid-cols-3 gap-8 container mx-auto px-4 sm:px-6 lg:px-8">
        <div>
          ...
          <p className="text-white text-sm">Email: ask@nexavira.info</p>
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <a
              href="https://github.com/nexavira"
              target="_blank"
            ...
            <a
              href="https://linkedin.com/company/nexavira"
              target="_blank"
              rel="noopener noreferrer"
              className="text-green-500 hover:text-green-400"
            >
            ...
            <a
              href="https://www.facebook.com/nexavira"
              target="_blank"
              rel="noopener noreferrer"
              className="text-green-500 hover:text-green-400"
            >
      ...
      <div className="mt-8 text-center text-white text-sm">
        © {currentYear} Nexavira. All rights reserved.
      </div>
    </footer>
  );
};
