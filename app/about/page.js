      ...
      <div className="max-w-4xl mx-auto mb-20">
        <div className="backdrop-blur-sm bg-black/20 border border-green-500/10 rounded-xl p-8 text-center">
          ...
          <p className="text-gray-300 text-lg leading-relaxed">
            At Quantanyx, we're dedicated to transforming innovative ideas into
            powerful digital solutions. Our mission is to empower businesses
            through cutting-edge technology while maintaining the highest
      ...
      <div className="mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="backdrop-blur-sm bg-black/20 border border-green-500/10 rounded-xl p-6">
            ...
            <p className="text-gray-400">
              Our agile methodology and experienced team ensure quick turnaround
